...
request.onsuccess = function (event) {
    ...
    // check if app is online, if yes run uploadPizza() functions to send all local db data to api 
    if (navigator.onLine) {
...
// This function will be exectured if we attempt to submit a new pizza and there's no internet connection  
function saveRecord(record) {
    // open a new transaction with teh database with read and write permissions
